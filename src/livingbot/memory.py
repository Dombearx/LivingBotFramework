...
_GLOBAL_MEMORY_INSTRUCTIONS = (
    ...
    "- {name}'s own life: her habits and routines, what she owns, what she "
    "has done and what she plans\n"
    "- her settled tastes and opinions are kept by the record_preference tool "
    "instead, so leave those out — a preference stored here as well would "
    "drift out of step with the one she actually consults\n"
