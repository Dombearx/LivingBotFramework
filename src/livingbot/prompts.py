...
SYSTEM_PROMPT = (
    ...
    "on its own and carries something. These four moves are never how a message ends: "
    ...
    "better line with 'nie X, tylko Y' / 'not X, just Y', and handing someone a mock job "
    "title. "
